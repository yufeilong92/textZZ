 ...
 * @Copyright: 2018
 */
public class NetVideoEvalueInfomModelImple implements NetVideoEvalueInfomModel {
    /**
     * 请求视频评价
     *
     * @param context
     ...
     */
    @Override
    public void requestVideoEvalueContent(Context context, final String videoid,String comid, int page, final RequestResulteView view) {

        NetService service = new NetService(context);
        service.requestVideoEvalueCom(videoid,comid, page, new StringCallBackView() {
            @Override
